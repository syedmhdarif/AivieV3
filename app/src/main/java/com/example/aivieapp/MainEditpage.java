...
public class MainEditpage extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
//    VideoView videoView;
...
//    ImageButton ssegment1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maineditpage);

//        //        ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, PackageManager.PERMISSION_GRANTED);
//
//        editpage = findViewById(R.id.Editpages);
//        editpage2 = findViewById(R.id.editsegment8);
//        meditspeed1 = findViewById(R.id.editSpeed1s);
//        mmusicedit = findViewById(R.id.musicedits);
//        meditaudio1 = findViewById(R.id.editAudio1);
//        videoView = findViewById(R.id.video_View);
////        seekBar = findViewById(R.id.seekBar2);
//        imageButton = findViewById(R.id.goback);
//        mbackgroundmatting = findViewById(R.id.backgroundmattings);
//
...
//
//        mc = new MediaController(MainEditpage.this);
...
//                if (ContextCompat.checkSelfPermission(MainEditpage.this, Manifest.permission.READ_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED){
//                    ActivityCompat.requestPermissions(MainEditpage.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 1);
//                }
//                else {
//                    selectVideo();
//                }
...
//    public void buttonPopupWindows(View view){
...
//        };
//    }
//    public void popupmenus(View view) {
